            ...
            <div class="-my-6">
                <div class="flex flex-wrap md:flex-nowrap">
                    ...
                    <div class="w-full md:w-1/4 pl-4">
                        ...
                        <a href="{{ route('postings.apply', $posting->slug) }}" class="block text-center my-4 tracking-wide bg-white text-indigo-500 text-sm font-medium title-font py-2 border border-indigo-500 hover:bg-indigo-500 hover:text-white uppercase">Apply Now</a>
                    </div>
                </div>
            </div>
        </div>
